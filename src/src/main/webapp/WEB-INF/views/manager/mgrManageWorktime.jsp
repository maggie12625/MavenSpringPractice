...
<meta charset="UTF-8">
<title>員工管理</title>
<link rel="stylesheet" type="text/css" href="css/mgrManageWorktime.css">
...
<div class="holdon-overlay" style="">
	...
	<div id="e_manage">
		<div>
			<ul id='em_ul'>
				<a href='./Worktime.do?action=checkWorktime_page' target="e_m_ifram"><li
					id="em_tab1" class="em_li_sel">工時審核</li></a>
				<a href='./Worktime.do?action=callWorktime_page' target="e_m_ifram"><li
					id="em_tab2">催繳工時</li></a>
			</ul>
			<div id='em_content_div'>
				<iframe name='e_m_ifram'
					src='./Worktime.do?action=checkWorktime_page'></iframe>
			</div>
		</div>
	</div>
</body>
