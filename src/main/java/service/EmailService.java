...
public class EmailService {
	...
	private Message getMessage() throws AddressException, MessagingException {
		...
		// 從哪裡發送
		try {
			message.setFrom(new InternetAddress("FJUT5EmailSystem@gmail.com", "工時系統-第三組"));
	...
	public static void main(String[] args) {
		...
		Text.append("我是第一行\n");
		Text.append("我是地2行");
		String[] emails = { "402180082@mail.fju.edu.tw", "josjos006@yahoo.com.tw", "josjos910052@gmail.com" };
		try {
